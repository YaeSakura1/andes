...
class ACDC3Term(ModelData, Model):
    """AC to three-terminal DC device template"""
    def __init__(self, system, config):
        ModelData.__init__(self)
        self.bus = IdxParam(model='Bus',
                            info="idx of connected bus",
        ...
        self.node3 = IdxParam(default=None,
                              info='Node 3 index',
                              mandatory=True,
                              model='Node',
                              )
        ...
        self.v3 = ExtAlgeb(model='Node',
                           src='v',
                           indexer=self.node3,
                           info='DC node 3 voltage',
                           )
