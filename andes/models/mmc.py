"""Modular multi-level converter models"""
...
class MMCShunt(ACDC2Term):
    """Data for MMC in power flow"""
    def __init__(self, system, config):
        ...
        self.psh = Algeb(info='active power injection into MMC',
                         tex_name="P_{sh}",
                         unit='p.u.',
        ...
        self.qsh = Algeb(info='reactive power injection into MMC',
                         tex_name="Q_{sh}",
